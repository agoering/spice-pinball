...
4. You may want to use analog inputs as <img src="{{ site.baseurl }}/docs/analog-piezo" style="width: 650px"/>, or you may come up with a clever use of an analog input (the one we just added, modeled after the light bar exercise, is just one example). 
