...
4. You may want to use the piezo with the peak detector circuit as we explored in <a href="{{ site.baseurl }}/docs/analog-piezo"></a>, or you may use it as a digital input as we explored in <a href="{{ site.baseurl }}/docs/readsensors/"></a>
